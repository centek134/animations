...
import {MenuAnimated, Cube, Circles, ImageBook, Sphere, Text, CurvedText, MovingPillars, Transformer} from "./containers/3d_animations/index.js";
...
import {Juggler} from "./containers/Svg_animations/index.js";
...
const animations_route_svg = [{path:"/svg-animations/juggler", element:<Juggler/>}
];
