...
import {MenuAnimated, Cube, Circles, ImageBook, Sphere, Text, CurvedText, MovingPillars} from "./containers/3d_animations/index";
//=============== 2D animations imports ================
import {HideAndSeek, Dots} from "./containers/2d_animations/index";
...
const animations_route_2d = [{path:"/2d-animations/hide-and-seek", element:<HideAndSeek/>},{path:"/2d-animations/dots", element:<Dots/>}];
